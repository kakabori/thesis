...
The rotation matrix for rotating a vector about y-axis is given by
\begin{equation}
  \begin{pmatrix} 
...
\begin{align}
  ...
  \label{eq:SM_Bragg}
\end{align}
Eq.~(\ref{eq:SM_Bragg}) indicates hemispherical shells of intensity with
...
conventional method to measure mosaic spread distribution is a rocking scan, where
