...
\newcommand{\xm}{x_\textrm{m}}
\newcommand{\xiM}{\xi_\text{M}}
\newcommand{\xim}{\xi_\text{m}}
\newcommand{\zhead}{z_\text{Head}}
\newcommand{\rhohead}{\rho_\text{Head}}

\newcommand{\Lbint}{$L_\beta\text{I}$}
\newcommand{\LbetaI}{$L_{\beta\text{I}}$}
\newcommand{\LbetaL}{$L_{\beta\text{L}}$}
\newcommand{\LbetaF}{$L_{\beta\text{F}}$}

\newcommand{\Dc}{D_\text{c}}
\newcommand{\lch}{\ell_\text{ch}}
\newcommand{\dcc}{d_\text{cc}}