...
Table~\ref{tab:instrumental_resolution} gives final 
horizontal and vertical instrumental resolution, $\Delta q_r$ and $\Delta q_z$,
taking into account the three contributions described in the preceding sections.
Those are estimated assuming usual square root additivity for
Gaussian widths and approximating $q_r \approx 0$ for LAXS and 
