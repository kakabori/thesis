...
\cite{ref:Tardieu73}. 
In this chapter, ``phase'' is used to refer to two different things: a thermodynamic phase
...
to also exist in unilamellar vesicles (ULVs) \cite{ref:Mason99} (more? include GUV?). 
...
However, a lack of 2D monoclinic lattice makes structural study using ULVs difficult
...
the ripple formation. Indeed, the size mismatch
...
is the hydration, which was shown to influence the monoclinic 
...
In \cite{ref:Sengupta00,ref:Sengupta03}, based on calculated electron density profiles 
...
in the ripple phase than in the gel phase as suggested in Sec.~\ref{sec:waxs_results}.
As discussed in
...
tWAXS where we were able to carefully measure the length of 
