...
In a giant unilamellar vesicle composed of a mixture of DPPC and dioleoylphosphatidylcholine (\gls{DOPC}), 
...
ripple phase depend on hydration level \cite{ref:Wack89} (see Table~\ref{tab:wack_lattice}). 
The best LAXS data from an unoriented sample were reported for $D$ = 57.9 \AA\ at $T$ = 18 \textcelsius.
In this thesis, 
to compare LAXS data from an oriented sample to the data from unoriented sample,
we studied a data set taken at $T$ = 18 \textcelsius\ and $D$ = 57.8 \AA.
The lattice constants for the data shown in Fig.~\ref{fig:ripple_laxs_images} are 
shown in Table~\ref{tab:wack_lattice}.
Some other data sets taken at different $D$ were also collected but not analyzed 
as thoroughly as the data presented in this thesis.
