...
Table~\ref{tab:LAXS_correction1} and \ref{tab:LAXS_correction2} summarize
the correction described in this section.

\begin{table}[htbp]
  \centering
    \begin{tabular}{rrrrr}
    \hline
    \multicolumn{1}{c}{$h$} & \multicolumn{1}{c}{$k$} & \multicolumn{1}{c}{Absorption} & \multicolumn{1}{c}{Mosaicity} & \multicolumn{1}{c}{Lorentz} \\
    \hline    
    1  & -1 & 1.96 & 2.63 & 14.16 \\
    1  & 0  & 1.41 & 2.56 & 0.11 \\
    1  & 1  & 1.79 & 2.56 & 12.67 \\
...
The density profile shows the same sawtooth profile that has been observed by
previous X-ray diffraction studies as well \cite{ref:Sun96,ref:Sengupta03,ref:Pabst04},
confirming the notion of height modulation in the ripple phase.
...
$x \approx$ -50 \AA\ to 50 \AA. This feature was not observed in the minor arm.
...
\begin{table}[htbp]
  ...
  III: Replaced lower order $|F(h,k)|$ with those from Wack and Webb, keeping the same relative error
  }
  \label{tb:LAXS_DHH}
\end{table}
