...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{figures/ripple/discussion/Sengupta_cartoon}
  \includegraphics[width=0.8\textwidth]{figures/ripple/discussion/major-arm_cartoon}
  \caption{(top) Chain packing in the major arm proposed by
  Sengupta \textit{et al.}, reproduced from \cite{ref:Sengupta03}.
  Chais are drawn as solid, straight lines, and headgroups as solid circles.
  Contours drawn are contour lines of the electron density map.
  Chains are parallel to the bilayer normal of the major arm.
  (bottom) Corresponding chain packing proposed in this thesis.
  ...
  Chains are titled by 18.4\textdegree\ toward the positive $x$ direction.}
...
\begin{figure}[htbp]
  ...
  The maximal scattering in the upper left  was at 
  $q_z \approx 0.4$ \AA$^{-1}$,
