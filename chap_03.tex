...
STN2002}. 
This value of $L$ indicates that chains in the upper and
...
\begin{figure}[htbp]
  ...
  {\jn Your previous caption gave more detail.  
  In either case, the normalization between left and right looks misleading.  
  Have to emphasize averages.  Also, you should use Origin to deconvolute the 
