...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{figures/ripple/tWAXS/twaxs_gel_qr_20}
...
$L_z \approx 31$ \AA. 
This value corresponds to the hydrocarbon thickness 
%2\gls{Dc} = 30.2~\AA\  
2$D_c$~=~30.2~\AA\
...
than full hydration ($D_\text{FH}\approx 66.0$~\AA \cite{ref:Chu05}).  
