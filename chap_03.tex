...
formed by dimyristoylphosphatidylcholine (DMPC) bilayers. 
...
calorimetry study of alkanes by sturevant (REF). 
The ripple phase provides an interesting opportunity
...
the X-ray diffraction pattern from {\jn dilllll (DLPC)} was phased 
...
the lamellar periodicity $D =$ 55.3 \AA\ the oblique angle
$\gamma =$ 110\textdegree, and ripple amplitude $A$ = 15 \AA.
...
is 
absent. The metastable symmetric phase has been observed in DPPC bilayers, but not
...
\begin{figure}[htbp]
  ...
  ($D$: $D$-spacing along $z$), ($\lambda_r=|\gls{a2}|$: ripple wavelength), 
...
While many studies used multilamellar samples, the ripple phase also exists in
unilamellar vesicles \cite{ref:Mason99}.

The ripple phase has been detected in
phosphatidylcholines (PC) and phosphatidylglycerol (PG) (REF),
but no ripple phase has been observed in bilayers composed of 
phosphatidylethanolamine (PE) headgroups.
...
the major arm is about twice as long as the minor arm. The major arm 
thickness perpendicular to the membrane plane 
was found to be larger than the corresponding minor arm thickness. The
...
, however, is not well captured in low angle scattering data.
Analysis of wide angle scattering could resolve this contended issue.

In a giant unilamellar vesicle composed of a mixture of DPPC and DOPC (ratio), 
...
asymmetric ripple where chains are gel-like in the major arm and
...
oriented sample because of strong absorption of X-rays due to a long 
path length within the sample at $\omega \approx$ 0\textdegree.
...
are the regions of $q$-space that could
not be probed by the detector when $\omega=0.5$. Because of the nonlinearity in the 
