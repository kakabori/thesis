...
subtracted background scattering data taken at incident angle -$\omega$ 
...
Figure~\ref{fig:strong_peak} also shows that there was a broader component
...
We also measured nGIWAXS of the DMPC fluid phase at $T$ = 30 \textcelsius\
...
angle X-ray scattering (TWAXS) of the DMPC gel L$_{\beta I}$ phase at 
$\omega$ = 45\textdegree.
...
can be seen. This was most likely due to slight displacement of mylar windows
...
Fig~\ref{fig:twaxs_gel}(right) was crucial in analyzing the TWAXS data. 
...
Figure~\ref{fig:twaxs_gel} shows intensity of observed Bragg rods along $q_z$ averaged in $q_r$
...
Figure~\ref{fig:twaxs_gel}(right) compares $\Delta q_z$ in the ripple and gel phases,
...
Finally, Fig.~\ref{fig:twaxs_qzplot} plots $q_z$ swath averaged between
$q_r$ = 1.465 \AA$^{-1}$ and 1.481 \AA$^{-1}$ and between
1.465 \AA$^{-1}$ and 1.51 \AA$^{-1}$. We found no obvious intensity maxima
below $q_z$ = 0.12 \AA$^{-1}$, asserting that the weaker peak was also
off the equator as discussed in Sec.~\ref{sec:nGIWAXS_results}.
There was also no sign of a third peak.
...
\begin{figure}[htbp]
  ...
  while the right profile extends over the whole ripple WAXS pattern.}
