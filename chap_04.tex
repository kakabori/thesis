...
\begin{figure}[jtbp]
  \centering
  \includegraphics[trim=100 0 100 0,clip,width=0.45\textwidth]{figures/ripple/MMs/laxs/olddopc045}
  \includegraphics[trim=100 0 100 0,clip,width=0.45\textwidth]{figures/ripple/MMs/laxs/olddopc044}
  ...
  a specular reflection from the substrate. \textcolor{red}{exposure time?}}
  \label{fig:olddopc}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{figures/ripple/MMs/transmission/geometric_broadening4}
...
Table~\ref{tb:obs_intensity} summarizes observed intensity from data shown
...
\begin{table}[htbp]
  ...
  \begin{tabular}{ccccc}
    ...
    \hline
  \end{tabular}
  \caption{Observed intensity}
  \label{tb:obs_intensity}
\end{table}
