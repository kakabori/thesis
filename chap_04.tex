...
integrated intensity is then larger for higher $h$ orders even if the intrinsic
relative intensity of different $h$ orders is the same. This effect is 
...
\begin{equation}
  ...
  \label{eq:mosaic_N}
\end{equation}
where a small angle approximation replaced $\sin\alpha$ in the 
numerator with $\alpha$.
