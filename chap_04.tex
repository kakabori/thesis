...
\begin{table}[htbp]
  ...
  \begin{tabular}{cccccccc}
    ...
    $z_{H1}$  & 19.8  & 19.7  & 18.1  & 19.5  & 18.7  & 19.1  & 19.0 \\
    $\sigma_{H1}$ & 3.43* & 3.43* & 2.94* & 3.06  & 2.51  & 2.94* & 2.97 \\
    $\rho_{H1}$ & 10.77* & 10.77* & 9.91* & 9.91* & 7.03  & 8.38  & 8.45 \\
    $z_{H2}$  & NA    & NA    & 20.0  & 20.4  & 22.4  & 23.2  & 23.0 \\
    $\sigma_{H2}$ & NA    & NA    & 1.47* & 3.17  & 1.38  & 1.47* & 1.72 \\
    $\rho_{H2}$ & NA    & NA    & 7.27* & 7.27* & 3.75  & 2.83  & 3.00 \\
    $\sigma_M$ & 1.67* & 1.67* & 1.83* & 2.47  & 2.53  & 1.83* & 1.87 \\
    $\rho_M$ & 9.23* & 9.23* & 10.9* & 10.9* & 5.15  & 6.87  & 6.97 \\
    \hline
  \end{tabular}
  \caption{Fit results. fit1 and fit2 used the M1G model while 
  fit3-7 used the M2G model. \\ *Parameters were fixed.}
  \label{tb:LAXS_fits}
\end{table}
...
$(q_r, q_z) \approx (1.457\textsl{•} \text{ \AA}^{-1}, 0.12 \text{ \AA}^{-1})$. 
