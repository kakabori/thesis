...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/holder_drawing1}
  \caption{Schematics of the sample holder showing a small piece I fabricated}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/sample_holder1.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/holder_drawing2}
  \caption{Schematics of the sample holder in the transmission mode.}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/sgeometry.png}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{figures/ripple/transmission/geometric_broadening1}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/geometric_broadening2}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/geometric_broadening3}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ripple/transmission/geometric_broadening4}
