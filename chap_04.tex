...
\begin{figure}
  ...
  Red circles are the positions of the observed peaks in $q$. The actual
...
Figure~\ref{fig:Fit5_2D_edp} plots a two dimensional electron density profile calculated
...
and (9, 0). We also noticed that the phase of (1, 3) was unstable. To study
...
In summary, we observed that the thickness of the bilayer in 
the major and minor arms did not vary too much among different models
and fits. The terminal methyl trough was also quite robust, but 
whether the minor arm has a small dip or rise in the density at the center
could not be determined. Table~\ref{tb:LAXS_summary} summarizes
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ripple/LAXS/major_diff_models}
  \caption{}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/ripple/LAXS/minor_diff_models}
  \caption{}
