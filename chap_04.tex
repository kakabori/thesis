...
of X-rays due to the sample, intensity near the equator was attenuated.
...
\begin{figure}[htbp]
  ...
  \caption{$q_r$ swaths of the ripple WAXS, each averaged over 0.02 \AA$^{-1}$. Each curve
  is shifted by 100 vertically. 
  The center $q_z$ values of swaths are shown in the figure legend.}
  \label{fig:qrplots}
\end{figure}
...
When the peak profile of the (2,0) peak in $q_r$ was fitted to a Lorentzian, we obtained
an excellent fit with its full width half maximum (FWHM) being the same as the instrumental resolution,
$\Delta q = 0.014$ \AA$^{-1}$. The center of the peak was estimated to be at $q_r$ = 1.479 \AA$^{-1}$.
