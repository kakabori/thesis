...
The most studied headgroup is phosphatidylcholine (\acs{PC}),
...
such as DMPC (see Fig.~\ref{fig:lipid_structure}) and dipalmitoylphosphaditylcholine (\acs{DPPC}). 
Lipids with one double bond
are called mono-unsaturated lipids, such as dioleoylphosphatidylcholine (\acs{DOPC}) shown in Fig.~\ref{fig:lipid_structure}.
