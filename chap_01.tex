...
\section{Lipid bilayers}\label{sec:lipid_bilayer}
...
shows a phase diagram of dimyristoylphosphatidylcholine (\acs{DMPC}).
Phosphatidylcholine (\acs{PC}) lipids constitute a substantial fraction of cell membranes
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{figures/fluid_phase}
  \qquad
  \includegraphics[width=0.45\textwidth]{figures/gel_phase}
...
chain saturation, and chain length. The most studied headgroup is 
phosphatidylcholine (\acs{PC}), consisting of phosphate and choline molecular groups. 
Lipid hydrocarbon chains can have one or more double bonds. Lipids with no 
double bonds in the chains are called saturated lipids, such as DMPC 
(see Fig.~\ref{fig:lipid_structure}) and dipalmitoylphosphatidylcholine (\acs{DPPC}). 
Lipids with one double bond are called mono-unsaturated lipids, such as 
dioleoylphosphatidylcholine (\acs{DOPC}) shown in Fig.~\ref{fig:lipid_structure}.
Unsaturation leads to chain packing frustration and lowers the melting temperature. 
...
Phosphatidylethanolamine (\acs{PE}) is a small 
headgroup, and packing of PE lipids leads to spontaneous membrane curvature.
The chemical structure of dioleoylphosphatidylechanolamine (\acs{DOPE}) is shown in Fig.~\ref{fig:lipid_structure}.
...
anionic, such as phosphatidylserine (\acs{PS}) and phosphatidylglycerol (\acs{PG}). 
...
The transactivator of translation (\acs{Tat}),
...
It has been suggested by \acs{MD} (molecular dynamics) simulations that Tat peptide first binds rather
